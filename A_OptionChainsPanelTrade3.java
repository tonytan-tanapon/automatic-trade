...
//
//class A_OptionChainsPanelTrade3 extends JPanel implements IContractDetailsHandler, IPositionHandler, IRealTimeBarHandler, 
...
//	String symbol = "AAPL";
//	MyOption myOption = new MyOption(symbol);
//	
...
//	{
//		Contract contract = this.myOption.optionchain.getCallATMContract();
...
//		this.myOption.sendOrder(sig, contract, posN, liveposition, qty);;
////		double sig = Double.parseDouble(inputSignal.getText());
////		System.out.println(" == = == = = \n");
////		
////	
////		OrderSend send = new OrderSend(this.myOption.optionchain.getCallATMContract());
////		String data = "Stock";
////		
////		double posN = Double.parseDouble(inputPos.getText());
////		double liveposition =  Double.parseDouble(inputLivePos.getText());
...
//		inputlastTradeDate.setText(this.myOption.lastTradeDate);
//
//	
//		processPosition();
//	}
...
//			
//			inputPrice.setText(""+this.myOption.historical.getClose());
//			
//			
//			//// process signal 
//			/// if sig 1 -> call 
